...
`id_csf` bigint(20) unsigned NOT NULL,
  ...
  `csf_pais` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `csf_parceiro` (`id_csf`, `cp_descricao`, `cp_pais`, `cp_ativo`) VALUES
(1, 'Alemanha/DAAD', 5, 1);
...
--
ALTER TABLE `csf`
MODIFY `id_csf` bigint(20) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `csf_parceiro`
--
ALTER TABLE `csf_parceiro`
MODIFY `id_csf` bigint(20) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
