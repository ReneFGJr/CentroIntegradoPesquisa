			...
			<div class="content">
				<nav>
					<ul id="menu-nav">
						...
						<li><a href="../swbexperience_en1st/index_en.php" style="color: #fff;"><img border="0" src="../swbexperience_en/img/eua_icon_flag_lang.png" title="English"/></a></li>
                		<li><a href="../swbexperience1st/index.php" style="color: #fff;"><img border="0" src="../swbexperience/img/brazil_icon_flag_lang.png" title="Portuguese"/></a></li>
