<?php
	$classAction = "index.php/Fomento/listar";
?>
			 ...
			 <table cellspacing="5">
			  <TR>
				<td><?php echo msg('fm_titulo'); ?><br/>
					<textarea name="titulo" cols=50 rows=3></textarea></td>
				
				<td><?php echo msg('fm_agencia'); ?><br/>
					<textarea name="agencia" cols=50 rows=3></textarea></td>
				<br/>
				<td><?php echo msg('fm_idioma'); ?><br/>
					<textarea name="idioma" cols=20 rows=3></textarea></td>
				</TR>
