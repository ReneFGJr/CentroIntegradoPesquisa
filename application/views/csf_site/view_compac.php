<table width="100%">
	<div>
		<tr>
			<td colspan=4 class="lt6 borderb1"style="border-left: 1px solid #333333"><B>Edital: <?php echo $ed_titulo; ?></B></td>
	...
	<div>
		...
		<tr>
			...
			<td align="left" class="lt2 border1" width="40%"><?php echo $cp_pais; ?></td>
		</tr>
