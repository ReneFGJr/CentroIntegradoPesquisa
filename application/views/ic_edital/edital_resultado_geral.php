<h1>Edital de Iniciação científica 2016/2017</h1>
<div class="row">
	<div class="col-md-4">
		...
		<ul>
			...
			<li><a href="<?php echo base_url('index.php/ic/resultado_de_bolsa_indicadas_edital/PIBIC/S');?>" class="link">Ciências Sociais Aplicadas</a></li>
			<li><a href="<?php echo base_url('index.php/ic/resultado_de_bolsa_indicadas_edital/PIBIC/H');?>" class="link">Ciências Humanas e Literatura</a></li>
		</ul>
	</div>
	<div class="col-md-4">
		...
		<ul>
			...
			<li><a href="<?php echo base_url('index.php/ic/resultado_de_bolsa_indicadas_edital/PIBITI/S');?>" class="link">Ciências Sociais Aplicadas</a></li>
			<li><a href="<?php echo base_url('index.php/ic/resultado_de_bolsa_indicadas_edital/PIBITI/H');?>" class="link">Ciências Humanas e Literatura</a></li>
		</ul>		
	</div>
	<div class="col-md-4">
		...
		<ul>
			...
			<li><a href="<?php echo base_url('index.php/ic/resultado_de_bolsa_indicadas_edital/PIBICEM/S');?>" class="link">Ciências Sociais Aplicadas</a></li>
			<li><a href="<?php echo base_url('index.php/ic/resultado_de_bolsa_indicadas_edital/PIBICEM/H');?>" class="link">Ciências Humanas e Literatura</a></li>
		</ul>		
	</div>
</div>
