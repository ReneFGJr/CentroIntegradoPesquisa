...
/* Background */
$img_file = 'img/certificado/swb2-2015.jpg';
...
$pdf->write2DBarcode('https://cip.pucpr.br/index.php/central_declaracao/validador/'.$id_dc.'/'.substr(checkpost_link($id_dc.'certificado'),4,6), 'QRCODE,L', 20, 210, 30, 30, $style, 'N');
$pdf -> SetFont('helvetica', '', 6);
$pdf->Text(20, 205, utf8_encode('LINK DE VALIDAÇÂO'));
