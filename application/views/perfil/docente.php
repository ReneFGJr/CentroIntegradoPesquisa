...
<table id="cabecalho-user-perfil" class="info-pessoais" border=0>
			...
			<div id="info-pesquisador" class="info-pesquisador lt1">
				...
				<li><strong>Regime:</strong> <?php echo $us_regime;?> </li>				
				...
				<li><strong>Stricto Sensu:</strong> <?php echo $us_ss;?></li>
				<li><strong>Bolsa produtividade:</strong> <?php echo $us_nada;?> </li>
				<li><strong>Carga horária:</strong> <?php echo $ush_total;?> horas</li>
