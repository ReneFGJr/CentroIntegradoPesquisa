...
<table width="100%">
	<tr>
		<td> <?php echo $nome_cita; ?>. <?php echo $sm_titulo;?>. In: SEMIC, Seminário de Iniciação Científica, 23, 2015, Curitiba-PR. Anais do 23º Seminário de Iniciação Científica. Curitiba: PUCPR, 2015. p. <?php echo $ref;?>.</td>
	</tr>
</table>
