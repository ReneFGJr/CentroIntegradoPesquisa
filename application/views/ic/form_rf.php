	...
	<tr valign="top">
		...
		<div id="area_sel" <?php echo $area_div;?>>
			<form method="post">
				...
				<br>
				<input type="submit" value="<?php echo msg('selecionar_area')?> >>" name="acao" class="btn btn-primary" style="width: 280px; text-align: center;">
		...
		<div id="idioma_sel" <?php echo $idioma_div;?>>
			<form method="post">
				...
				<br>
				<input type="submit" value="<?php echo msg('selecionar_idioma')?> >>" name="acao" class="btn btn-primary" style="width: 280px; text-align: center;">
