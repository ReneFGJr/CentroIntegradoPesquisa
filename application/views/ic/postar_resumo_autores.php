<table width="100%"  border=0 class="lt2">
	...
	<tr>
		<td><input type="text" id="dd1" class="form_string" style="width: 100%;"></td>
		<td><select id="dd2" class="form_string" style="width: 100%;" size=1>
			<option value=""></option>
		...
		<td><input type="text" id="dd3" class="form_string" style="width: 100%;"></td>
