<?php
class ic_master extends CI_Controller {
	...
	function cab() {
		...
		$data['title_page'] = 'Iniciaзгo Cientнfica - Master';
		$data['menu'] = 1;
		$this -> load -> view('header/cab', $data);

		$this -> load -> view('header/content_open');
		$data['logo'] = base_url('img/logo/logo_ic_master.png');
	...
	function index($id = 0) {
		...
		$data['resumo'] = $this -> ics_master -> resumo();
		$data['search'] = '';
	...
	function resumo($st = '') {
		...
		$data['resumo'] = $this -> ics_master -> resumo();
		$data['search'] = $this -> ics_master -> mostra_protetos($st);
		;
