...
class email_local extends CI_Model {
	function enviaremail($para, $titulo, $texto) {
		...
		$config = Array('protocol' => 'smtp', 'smtp_host' => 'smtps.pucpr.br', 'smtp_port' => 465, 'smtp_user' => 'rene.gabriel@pucpr.br', 'smtp_pass' => 'Eduardo@22', 'mailtype' => 'html', 'charset' => 'iso-8859-1', 'wordwrap' => TRUE);
