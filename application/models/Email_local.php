...
class email_local extends CI_Model {
	...
	function enviaremail($para, $titulo, $texto) {
		...
		$config = Array('protocol' => 'smtp', 'smtp_host' => 'smtp.office365.com', 'smtp_port' => 587, 'smtp_user' => 'rene.gabriel@pucpr.br', 'smtp_pass' => 'Eduardo@23', 'mailtype' => 'html', 'charset' => 'iso-8859-1', 'wordwrap' => TRUE);
